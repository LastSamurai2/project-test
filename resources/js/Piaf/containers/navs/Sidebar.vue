        ...
        <div class="sub-menu">
            ...
            >
                ...
                >
                    ...
                    >
                        <a v-if="sub.newWindow" :href="route(sub.to)" rel="noopener noreferrer" target="_blank">
                            <i :class="sub.icon"/>
                        ...
                        <template v-else-if="sub.subs &&  sub.subs.length > 0">
                            <b-link
                                ...
                                variant="link"
                                class="rotate-arrow-icon opacity-50" z
                            >
                            ...
                            <b-collapse visible :id="`menu_${itemIndex}_${subIndex}`">
                                <ul class="list-unstyled third-level-menu">
                                    ...
                                    >
                                        ...
                                        <b-link v-else :to="thirdLevelSub.to">
                                            <i :class="thirdLevelSub.icon"/>
                                            <span>{{ $t(thirdLevelSub.label) }}</span>
                                        </b-link>
                                    </li>
                        ...
                        <jet-dropdown-link v-else :href="route(sub.to)">
                            <i :class="sub.icon"/>
                            <span>{{ $t(sub.label) }}</span>
                        </jet-dropdown-link>
                    </li>
